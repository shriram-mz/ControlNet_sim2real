...
model = create_model(f'/mnt/disks/data/sim2real/ControlNet/models/control_v11f1e_sd15_tile.yaml').cpu()
#model.load_state_dict(load_state_dict('./models/v1-5-pruned.ckpt', location='cuda'), strict=False)
model.load_state_dict(load_state_dict(f'/mnt/disks/data/sim2real/ControlNet/models/control_v11f1e_sd15_tile.pth', location='cuda'), strict=False)
model = model.cuda()
